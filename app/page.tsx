...
function BrandLogo() {
  return (
    <span className="hanwha-logo apr-logo" aria-label="APR">
      <img src="/assets/apr-logo.png" alt="" aria-hidden="true" />
    </span>
  );
}
    ...
    <main className="portfolio">
      ...
      <section className="cover-page" data-page id="introduction" aria-labelledby="portfolio-title">
        ...
        <div className="profile-details">
          <h1 id="portfolio-title"><span>고객의 <em>경험과 운영</em>을</span><span className="cover-title-follow"><em>끝까지</em> 개선하는 개발자</span></h1>
          <PersonalStrengths />
      ...
      <section className="journey-page" data-page id="journey" aria-labelledby="journey-title">
        ...
        <div className="journey-map">
          ...
          <div className="journey-destination">
            <img src="/assets/apr-logo.png" alt="APR" width="400" height="150" />
            <p>쌓아온 경험을,<br /><strong>에이피알에서 이어가겠습니다.</strong></p>
          </div>
        </div>
      </section>
